...
# 開場白與上課模式{務必先聽完如何使用本課程與相關規範} [[0211課程的錄影]](https://youtu.be/YvQH03hj8mI)
- 說明採兩種模式進行:(1)預錄模式 (2)Google Meet線上直播模式
- 本次課程主要採 (2)Google Meet線上直播模式,部分解題採預錄模式(就是錄影後,放在YOUTUBE讓你觀看學習的啦)
